...
public class Labyrint {
  ...
  public ArrayList<ArrayList<Tuppel>> finnUtveiFra(int rad, int kol) {
    ...
    ArrayList<Tuppel> tomSti = new ArrayList<>();
    startRute.finn(null, tomSti);
    return utveier;
  }

  /** Legg til utvei */
  public void addUtvei(ArrayList<Tuppel> utvei) { utveier.add(utvei); }
  ...
  public int getAntRader() { return antRader; }

  public int getAntKolonner() { return antKolonner; }

  public int getAntHvite() { return antHvite; }

  public int getAntSorte() { return antSorte; }

  public int getAntAapninger() { return antAapninger; }
}
